...
static MunitResult test_heap_insert(const MunitParameter params[], void *data)
{
    ...
    for (int i = 0; i < heap->size; i++)
        printf("%d", *(int *)((char *)heap->data + (i * heap->element_size)));
    printf("\n\n\n");
    */
    ...
    {
        /* debug
        void *result1 = malloc(heap->size);
        heap_peek(heap, result1);
        printf("%d ", *(int *)((char *)result1));
        printf("\n");
        for (int i = 0; i < heap->size; i++)
            printf("%d", *(int *)((char *)heap->data + (i * heap->element_size)));
        printf("\n\n\n");
...
static MunitResult test_heap_merge(const MunitParameter params[], void *data)
{
    ...
    for (int i = 0; i < heap1->size; i++)
        printf("%d", *(int *)((char *)heap1->data + (i * heap1->element_size)));
    printf("\n\n\n");
    */
